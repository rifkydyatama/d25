-- =====================================================
-- D25 TEKNOLOGI PENDIDIKAN - PRODUCTION DATABASE MIGRATIONS
...
CREATE TABLE orders (
    ...
    payment_status VARCHAR(50) DEFAULT 'unpaid' CHECK (payment_status IN ('unpaid', 'paid', 'failed', 'refunded', 'pending')),
    payment_id VARCHAR(255),
    payment_type VARCHAR(50),
    payment_details JSONB,
    payment_va_number VARCHAR(100),
    payment_va_expiry TIMESTAMPTZ,
    payment_va_response JSONB,
...
('payment_methods', '["midtrans_snap", "bank_bni", "bank_bri", "bank_permata"]', 'Metode pembayaran yang tersedia'),
('max_cart_quantity', '10', 'Maksimal quantity per item di keranjang')
ON CONFLICT (key) DO NOTHING;

-- =====================================================
-- 12. STORAGE BUCKET (Run in Storage section)
-- =====================================================
